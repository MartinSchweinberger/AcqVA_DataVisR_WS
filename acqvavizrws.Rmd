...
install.packages(c("tidyverse", "here", "vcd", "likert", "knitr", 
                   "markdown", "rmarkdown"), dependencies = T)
```
...
```{r}
# load xlsx data
myxlsx <- readxl::read_xlsx(here::here("data", "sampledata.xlsx"), sheet = 1)
...
```{r}
# load csv file
mycsv <- read.csv(here::here("data", "sampledata.csv"))
# inspect data
head(mycsv)
```
...
```{r}
# load xlsx data
mytxt <- read.delim(here::here("data", "sampledata.txt"), sep = "\t")
# inspect data
head(mytxt)
```
...
```{r}
# load xlsx data
myrda <- readRDS(here::here("data", "sampledata.rda"))
# inspect data
head(myrda)
```
