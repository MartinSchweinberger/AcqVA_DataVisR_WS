...
Install the packages you need for this workshop (this will take a couple of minutes).
...
![Target: exercise boxplot](https://github.com/MartinSchweinberger/AcqVA_DataVisR_WS/tree/main/images/exboxplot.png)
