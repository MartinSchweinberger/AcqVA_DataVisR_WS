...
```{r install1, eval = F, message=F, warning=F}
# update R
...
```{r install2, eval = F, message=F, warning=F}

install.packages("vcd", dependencies = T)
install.packages("xlsx", dependencies = T)
install.packages("likert", dependencies = T)

install.packages(c("dplyr", "ggplot2", "here", "tidyr", "sjPlot", "readxl"), dependencies = F)
```
