---
title: "Introduction to Data Visualization with R - AcqVA AUroa workshop "
...
The entire R Notebook for the tutorial can be downloaded [**here**](https://slcladal.github.io/kwics.Rmd).  If you want to render the R Notebook on your machine, i.e. knitting the document to html or a pdf, you need to make sure that you have R and RStudio installed and you also need to download the [**bibliography file**](https://slcladal.github.io/bibliography.bib) and store it in the same folder where you store the Rmd file. <br><br>
