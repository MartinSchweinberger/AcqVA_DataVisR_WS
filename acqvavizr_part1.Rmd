---
title: "Introduction to Data Visualization with R - AcqVA Aurora workshop - part 1 "
...
This tutorial introduces data visualization using R with the aim of showcasing how to visualize data and how to adapt, change, and modify visualizations using the `ggplot2` package [@ggplot2]. 

```{r diff, echo=FALSE, out.width= "20%", out.extra='style="float:right; padding:10px"'}
...
## Background: visualizing data with R {-}
